...
class neuSucheAuswahlView extends StatelessWidget {
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  title: Text('Was suchst du heute bei uns?'),
                ),
                SizedBox(height: 20,),
                ...
                RaisedButton(
                  onPressed: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SearchVeranstalltungView()));
                  },
                  elevation: 16,
                ...
                RaisedButton(
                  onPressed: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SearchEquipmentView()));
                  },
                  elevation: 16,
                  disabledColor: Colors.red[900],
                  color: Colors.red,
                ...
                RaisedButton(
                  onPressed: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SearchRaumView()));
                  },
                  elevation: 16,
                  disabledColor: Colors.red[900],
                  color: Colors.red,
